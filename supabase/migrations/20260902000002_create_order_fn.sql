-- Função para criar pedido de forma atômica:
-- 1. checa idempotência, 2. bloqueia estoque, 3. cria pedido + itens
...
BEGIN
  ...
  -- Criar pedido
  INSERT INTO orders (
    public_id, customer_name, customer_email, pickup_date,
    total_amount, payment_status, order_status, idempotency_key
  ) VALUES (
    v_public_id, p_customer_name, p_customer_email, p_pickup_date,
